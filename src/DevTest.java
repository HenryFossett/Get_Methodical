...
//    int testScore = 0;
//    testScore = getRangedInt(testScan, "Enter your test score [0-100]", 0, 100);
//        System.out.println(testScore);

//    double salary = 0;
//    salary = getRangedDouble(testScan, "Enter your salary [30000-1000000]", 30000, 1000000);
//        System.out.println(salary);

//    boolean check;
//    check = getYNConfirm(testScan, "Do you like chocolate [Y/N]");
